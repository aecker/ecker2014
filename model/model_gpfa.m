...
% TODO: APPLY DIFFERENT PHASES FOR EACH NEURON!!

x = binornd(1, repmat(r, [1 1 N]));
mu = mean(x, 2);
...
%% Fit GPFA model
k = 20;
y = reshape(x0, [k, T / k, M, N]);
y = permute(sum(y, 1), [4 2 3 1]);
model = fit(GPFA, y, 1);
