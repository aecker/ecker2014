%{
nc.EvokedLfpProfile2 (computed) # stimulus-evoked LFP profile over layers
...
classdef EvokedLfpProfile2 < dj.Relvar & dj.AutoPopulate
    properties(Constant)
        table = dj.Table('nc.EvokedLfpProfile2');
    ...
    methods 
        function self = EvokedLfpProfile2(varargin)
